...
| [0040](0040-the-plugin-is-a-hook-manifest.md) | The plugin is a hook manifest, and each job behind it is a module | accepted, refines 0008, 0014, 0016, 0032, 0037 and 0039; structural only; its `plugin/verdict.py` placement and its manifest's exports are superseded by 0041 |
| [0041](0041-the-vocabulary-is-a-domain-noun-and-the-manifest-is-a-manifest.md) | A shared vocabulary is a domain noun, and a manifest exports nothing of its own | accepted, refines 0016, 0037, 0038 and 0039; supersedes 0040's placement of `Verdict`; structural only |
| [0042](0042-the-overview-is-filtered-by-the-url.md) | The overview is filtered by the URL, and the summary aggregates the chart's own groups | accepted, refines 0020, 0021, 0028 and 0031 |
| [0043](0043-the-overview-tables-are-budgeted-to-one-screen.md) | The overview's tables are budgeted to one screen, and the aggregate has a decomposition as well as an accumulation | accepted, refines 0020, 0021, 0025, 0031 and 0042 |
